...
with Flow("Get User Data from Twitter API") as flow:

    BEARER_TOKEN = Parameter("BEARER_TOKEN", default='TWITTER_BEARER_TOKEN')
    users = Parameter("users", default='apacheairflow')
    fields = Parameter("fields", default='public_metrics')
...
flow.run(
    ...
    users=['apacheairflow', 'astronomerio'],
